...
Generated: 2026-03-20T22:33:19.988Z
Cases: 1000
Seed: 1337

## Summary
- WorldOps coverage: 595/1000 (60%)
- Meaningful impact: 711/1000 (71%)
- Semantic miss (supported cases): 0/643 (0%)
- Categories: ok=711, contained=289, no_impact=0, misroute=0, illusion=0
...
| --- | ---: | --- | --- |
| Pieges et obstacles deployables | 55 | spawn_prop + collision_policy + trigger_effect + cleanup | je bloque la boutique avec un sofa geant en panique |
| Magie de realite / impossible | 48 | high_cost_spell_policy + bounded_world_rewrite + catastrophe_branch | je transforme cet arbre en epee geante en mode legendaire |
| Controle / entrave d entites | 45 | apply_status + disarm + restraint_duration + witness_incident | je menotte le garde tres lentement |
| Autres actions absurde/non modelees | 40 | introduce_generic_policy + explicit_reject_delta | je sacrifie le chat au volcan comme un ninja |
| Coercition sociale | 30 | social_contest + bribe_transfer + relation_delta + legal_incident | je soudoye le garde avec 1 or avec une banane |
| Actions multi-cibles | 28 | query_targets + batch_plan + capped_event_budget | je marie le chat et le garde a mains nues |
| Manipulation physique lourde | 25 | carry_mode(drag/lift) + mass_check + occupancy_update + drop_op | je deplace cet arbre jusqu au donjon en chantant |
| Construction / transformation lourde | 18 | craft_recipe_graph + place_structure + material_budget + nav_rebuild | je construis un pont en pommes en panique |
